...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "README.txt", "Rakefile", "lib/ogg/codecs/comments.rb", "lib/ogg/codecs/speex.rb", "lib/ogg/codecs/vorbis.rb", "lib/ogg/page.rb", "lib/ogg/reader.rb", "lib/ogg/writer.rb", "lib/ogg.rb", "lib/ogginfo.rb", "setup.rb", "test/test_ruby-ogginfo.rb", "test/test_ruby-spxinfo.rb"]
  ...
  s.test_files = ["test/test_ruby-ogginfo.rb", "test/test_ruby-spxinfo.rb"]
